...
import mall.search.util.HighlightResultMapper;
import mall.util.PageInfo;
...
public class SkuSearchServiceImpl implements SkuSearchService {
    ...
    public Map<String, Object> search(Map<String, Object> searchMap) {
        ...
        PageInfo pageInfo = new PageInfo(page.getTotalElements(),currentpage, pagesize);
    ...
    public NativeSearchQueryBuilder queryBuilder(Map<String, Object> searchMap){
        ...
        //分页查询
        builder.withPageable(PageRequest.of(currentPage(searchMap),getSize(searchMap)));
    ...
    public int getSize(Map<String,Object> searchMap){
        try {
            Object size = searchMap.get("size");
